...
- [🧩 Agents in the System](#-agents-in-the-system)
  - [1. 🧠 Decision Agent — app/agents/decision_agent.py](#1--decision-agent--appagentsdecision_agentpy)
  - [2. 🎯 Intent Agent — app/agents/intent_agent.py](#2--intent-agent--appagentsintent_agentpy)
  - [3.  Risk Agent — app/agents/risk_agent.py](#3--risk-agent--appagentsrisk_agentpy)
  - [4. 🧬 Memory Agent — app/agents/memory_agent.py](#4--memory-agent--appagentsmemory_agentpy)
  - [5. 🔁 Lifecycle Agent — app/agents/lifecycle_agent.py](#5--lifecycle-agent--appagentslifecycle_agentpy)
  - [6. 📄 Extraction Agent — app/agents/extraction_agent.py](#6--extraction-agent--appagentsextraction_agentpy)
  - [7. ✅ Validation Agent — app/agents/validation_agent.py](#7--validation-agent--appagentsvalidation_agentpy)
  - [8. 🔒 Finalization Agent — app/agents/finalization_agent.py](#8--finalization-agent--appagentsfinalization_agentpy)
  - [9. 👤 Entry Agent — app/agents/entry_agent.py](#9--entry-agent--appagentsentry_agentpy)
- [🛠 Tooling System](#-tooling-system)
  - [Tool Registry — decision_agent.py](#tool-registry--decision_agentpy)
...
- [🔗 LangGraph Framework Integration](#-langgraph-framework-integration)
  - [State Schema — app/db/schemas.py](#state-schema--appdbschemaspy)
...
- [📊 Observability & Error Tracking](#-observability--error-tracking)
  - [Structured Logging — Loguru](#structured-logging--loguru)
  - [Error Tracking — Sentry](#error-tracking--sentry)
- [🔍 OCR & Document Extraction Pipeline](#-ocr--document-extraction-pipeline)
  - [Tier 0 — OCR.space 4.0 (Primary)](#tier-0--ocrspace-40-primary)
  - [Tier 2 — Gemini Vision AI (Fallback)](#tier-2--gemini-vision-ai-fallback)
  - [Filename-Based Document Routing](#filename-based-document-routing)
  - [SME Concurrent Processing](#sme-concurrent-processing)
- [☁️ Cloud Infrastructure & Deployment *(Updated)*](#️-cloud-infrastructure--deployment)
  - [Production Stack (AWS)](#production-stack-aws)
...
- [Technology Stack](#technology-stack)
  ...
  - [2. Create Virtual Environment](#2-create-virtual-environment-1)
  - [3. Install Dependencies](#3-install-dependencies-1)
  - [4. Configure Environment Variables](#4-configure-environment-variables-1)
  - [5. Initialize Database](#5-initialize-database-1)
  - [6. Start Services](#6-start-services-1)
- [▶️ Usage & API Endpoints](#️-usage--api-endpoints)
...
- [📊 Architecture Diagrams](#-architecture-diagrams)
  ...
  - [4. Sequence Diagram - Account open(Retail, SME and Digital)](#4-sequence-diagram---account-openretail-sme-and-digital)
  - [4. Parent Lifecycle System — Re-KYC & Reactivation](#4-parent-lifecycle-system--re-kyc--reactivation)
